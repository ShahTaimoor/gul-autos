...
const Footer = () => {
  ...
  <div className="relative container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 lg:px-0">
    {/* Company Name */}
    <div className="backdrop-blur-sm bg-white/70 p-6 rounded-xl shadow-sm animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
      <h3 className="text-xl font-bold mb-3 text-gray-800">GULTRADERS</h3>
      <p className="text-sm text-gray-600 font-medium">BODY KITS & CAR ACCESSORIES</p>
      <div className="mt-4 flex space-x-3">
        <a href="#" className="text-gray-500 hover:text-blue-500 transition-transform duration-200 hover:scale-110">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
          </svg>
        </a>
        <a href="#" className="text-gray-500 hover:text-pink-500 transition-transform duration-200 hover:scale-110">
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {/* Contact */}
    <div className="backdrop-blur-sm bg-white/70 p-6 rounded-xl shadow-sm animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="space-y-2">
       ...
       {/* Address */}
       <div className="backdrop-blur-sm bg-white/70 p-6 rounded-xl shadow-sm animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
    ...
    {/* Map */}
    <div className="backdrop-blur-sm bg-white/70 p-1 rounded-xl shadow-sm overflow-hidden lg:col-span-1 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
      <iframe 
  ...
  {/* Bottom Bar */}
  <div className="relative container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
