...
const Footer = () => {
  ...
  <div className="relative container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 lg:px-0">
    {/* Company Name */}
    <div 
      className="backdrop-blur-sm bg-white/70 p-6 rounded-xl shadow-sm transition-all duration-500 ease-out opacity-0 animate-fade-in-up"
    ...
    >
      ...
      <div className="mt-4 flex space-x-3">
        ...
        <a 
          href="#" 
          className="text-gray-500 hover:text-pink-500 transition-transform duration-200 hover:scale-110"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {/* Map */}
    <div 
      className="backdrop-blur-sm bg-white/70 p-1 rounded-xl shadow-sm overflow-hidden lg:col-span-1 transition-all duration-500 ease-out opacity-0 animate-fade-in-up"
  ...
  {/* Bottom Bar */}
  <div 
    className="relative container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6 transition-all duration-500 ease-out opacity-0 animate-fade-in-up"
