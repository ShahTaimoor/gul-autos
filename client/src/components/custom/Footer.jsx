...
const Footer = () => {
  ...
  <div className="relative container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 lg:px-0">
    ...
    <div className="backdrop-blur-sm bg-white/70 p-6 rounded-xl shadow-sm animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 font-medium mb-4">BODY KITS & CAR ACCESSORIES</p>
